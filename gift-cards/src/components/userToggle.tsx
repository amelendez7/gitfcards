...
import { HiCog, HiCurrencyDollar, HiLogout, HiViewGrid, HiUser } from 'react-icons/hi';
  ...
  return (
    ...
    >
      ...
      <EditUserModal
        ...
        badge={user}
      />
      <ListGroup.Item href="/bonuses/all" icon={HiCurrencyDollar}>
        Earnings
      </ListGroup.Item>
      <Dropdown.Divider />
      <ListGroup.Item href="/" onClick={handleLogout} icon={HiLogout}>
        Log Out
      </ListGroup.Item>
    </Dropdown>
  )
